                            ...
                            {rollData.step === 'result' && (
                                <div className="animate-scale-up">
                                    ...
                                    <div className="flex gap-4 mt-6">
                                         ...
                                         {/* If it was a move roll, show Damage Roll button */}
                                         {rollData.mode === 'move' && rollData.activeMove && rollData.activeMove.damagePool && (
                                             <button 
                                                onClick={prepareDamageRoll}
                                                className="flex-1 py-3 bg-red-500 hover:bg-red-600 text-white rounded-xl font-bold shadow-lg transition-colors flex items-center justify-center gap-2"
                                             >
                                                 <Swords size={20} /> Roll Damage
                                             </button>
                                         )}
                                    </div>
                                </div>
